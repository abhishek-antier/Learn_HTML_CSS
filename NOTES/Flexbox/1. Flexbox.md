...
To put the content on the Main axis, we need to use the property, justify-content: flex-start
...
<img src="./images/flexbox.png" alt="Flex Container with Main Axis and Cross Axis" width="620" height="800" />
